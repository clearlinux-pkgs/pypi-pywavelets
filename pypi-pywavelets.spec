...
Source0  : https://files.pythonhosted.org/packages/94/0a/c235e7dd60d136b14cd8793c440e8d22e7880df5588162feb02d6d6118a3/pywavelets-1.7.0.tar.gz
...
BuildRequires : pypi(jupyterlite_pyodide_kernel)
BuildRequires : pypi(jupyterlite_sphinx)
...
Requires: pypi(jupyterlite_pyodide_kernel)
Requires: pypi(jupyterlite_sphinx)
...
%prep
%setup -q -n pywavelets-1.7.0
cd %{_builddir}/pywavelets-1.7.0
pushd ..
cp -a pywavelets-1.7.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730215815
